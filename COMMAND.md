...
```bash
  ...
  -o "beta3"
  model/ListaCircularDoble.cpp utils/Validaciones.cpp 
  view/MenuUI.cpp view/MenuController.cpp view/StringProcessor.cpp 
  controller/EventManager.cpp controller/ReservationManager.cpp 
  controller/Exhaustiva.cpp controller/DivideYVenceras.cpp controller/Voraz.cpp
  controller/main.cpp 
